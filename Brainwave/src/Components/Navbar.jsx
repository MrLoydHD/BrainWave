...
function Navbar() {
  ...
  return (
    <div className="navbar bg-primary z-30 font-bold">
      ...
      <div className="flex-none">
        <ul className="menu menu-horizontal text-xl px-1 mr-4">
          <li tabIndex={0} className='z-20'>
              ...
              <ul className="p-2 lili text-lg bg-base-100">
          ...
          <li tabIndex={0}>
              ...
              <ul className="p-2 lili text-lg bg-base-100 z-20">
      ...
      <div className="dropdown dropdown-end">
          ...
          {notificationOn && (
            <ul tabIndex={0} className="mt-3 lili p-2 h-auto shadow menu dropdown-content bg-base-100 rounded-box w-96">
              {userType === 'teacher' && (
                <>
      ...
      <div className="dropdown dropdown-end mr-4">
        ...
        {avatarOn && (
          <ul tabIndex={0} className="mt-3 lili p-2 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
            <li>
