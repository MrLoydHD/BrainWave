    ...
    <div>
        ...
        <div>
            <div className="items-center mb-10 mt-4">
                ...
                <select id="disciplina" name="disciplina" className="select select-bordered w-2/3">
                    <option value="">Todas as disciplinas</option>
                    <option value="matematica">Matemática</option>
                    <option value="fisico-quimica">Fisico-Química</option>
                    <option value="biologia-geologia">Biologia e Geologia</option>
                </select>
            </div>
            <div className="items-center mb-10">
                <h3 htmlFor="precoMaximo" className="text-xl font-bold mb-4">Preço Máximo: {valorSlider}€/mês</h3>
                <Slider min={0} max={100} value={valorSlider} onChange={handleChange} className='slider-custom'/>
            </div>
            <div className='mb-10'>
                ...
                <div name="Feedback">
                    <div className="form-control">
                        <label className="label cursor-pointer">
                            ...
                            <input type="radio" name="radio-10" className="radio checked:bg-black-500" />
                        </label>
                    </div>
                    <div className="form-control">
                        <label className="label cursor-pointer">
        ...
        <div className='flex justify-center'>
            <button className="btn btn-black py-4 text-xl text-white text-center">Aplicar filtros</button>
        </div>
    </div>
  );
}
